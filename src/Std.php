...
class Std
{
    ...
    public static function drawYpmnButton(array $params): string
    {
        ...
        if (!empty($params['qr'])) {
            $inner_block = '
                <img src="data:image/svg+xml;base64,' . $params['qr'] . '" alt="QR Code" class="w-100" style="max-width: 100%!;">
            ';
        } else {
            $inner_block = '
